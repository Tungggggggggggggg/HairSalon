                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Chào mừng bạn đến với JShop
                                <br>Vui lòng đăng nhập
                            </h3></div>
                            <div class="card-body">
                                <form action="/login" method="post">
                                    <c:if test="${param.error != null}">
                                        <div class="my-2" style="color: red;">Sai Email hoặc Mật khẩu vui lòng nhập lại </div>
                                    </c:if>
                                    <c:if test="${param.logout != null}">
                                        <div class="my-2" style="color: red;">Bạn đã đăng  xuất thành công </div>
                                    </c:if>

                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputEmail" name="username" type="email" placeholder="name@example.com" />
