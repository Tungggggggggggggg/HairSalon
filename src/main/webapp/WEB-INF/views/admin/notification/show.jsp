            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="mb-3">
                            <a href="/admin/notification/create" class="btn btn-success btn-custom-green"><i class="fas fa-plus"></i> Tạo mới</a>
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="btn btn-secondary" href="/admin/notification/detail">chi tiết</a>
                                    <a type="button" class="btn btn-secondary" href="/admin/notification/update">cập nhật</a>
                                    <a type="button" class="btn btn-secondary" href="/admin/notification/delete">xóa</a>
                                </td>
                            </tr>
