                ...
                <div >
                    <div class="card" style="width: 60%;">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Tên dịch vụ : </li>
                            <li class="list-group-item">Mô tả:</li>
                            <li class="list-group-item">Giá:  (VND)</li>
                            <li class="list-group-item">Thời gian hoàn thành dịch vụ:</li>
                            <li class="list-group-item">Ngày tạo: </li>
                        </ul>
                        <a href="/admin/service" class="btn btn-success">Trở về</a>
                    </div>
                </div>
