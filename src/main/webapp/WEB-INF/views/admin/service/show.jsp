            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="mb-3">
                            <a href="/admin/service/create" class="btn btn-success btn-custom-green"><i class="fas fa-plus"></i> Tạo mới</a>
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                <td>123</td>
                                <td>Nhộm tóc</td>
                                <td>rất đẹp sử dụng thuốc nhộm chiết xuất từ thiên nhiên phù hợp với mọi loại da đầu nhảy cảm </td>
                                <td>2.000.000</td>
                                <td>60</td>
                                <td>20/11/2024 - 12-22-12</td>
                                <td>
                                    <a type="button" class="btn btn-secondary" href="/admin/service/detail">chi tiết</a>
                                    <a type="button" class="btn btn-secondary" href="/admin/service/update">cập nhật</a>
                                    <a type="button" class="btn btn-secondary" href="/admin/service/delete">xóa</a>
                                </td>
                            </tr>
