                        ...
                        <table id="salaryTable" class="table table-bordered table-hover">
                            ...
                            <c:forEach var="staffSalary" items="${staffSalarys}">
                                <tr>
                                    ...
                                    <td><fmt:formatNumber value="${staffSalary.baseSalary}" type="number" /></td>
                                    <td><fmt:formatNumber value="${staffSalary.bonus}" type="number" /></td>
                                    <td><fmt:formatNumber value="${staffSalary.totalSalary}" type="number" /></td>
                            ...
                            <tr>
                                ...
                                <th><fmt:formatNumber value="${totalSalary}" type="number" /></th>
                                <th></th>
                            </tr>
                            </tfoot>
                        </table>
