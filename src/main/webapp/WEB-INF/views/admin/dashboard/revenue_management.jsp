                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <form method="get" action="/admin/revenue_management/excel">
                                <c:if test="${not empty startDate and not empty endDate}">
                                    <input type="hidden" name="startDate" value="${startDate}">
                                    <input type="hidden" name="endDate" value="${endDate}">
                                </c:if>
                                <button type="submit" class="btn btn-success"><i class="fas fa-file-excel"></i> Xuất ra Excel</button>
                            </form>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <c:forEach var="revenue" items="${revenues}">
                                        <tr>
                                            ...
                                            <!-- Sử dụng phương thức định dạng ngày -->
                                            <td>${revenue.formattedSummaryDate}</td>
