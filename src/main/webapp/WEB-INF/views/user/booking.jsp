...
<html lang="vi">
    ...
    <body>
            ...
            <div class="appointment-section">
                ...
                >
                    ...
                    <input
                        ...
                        id="notes"
                        name="notes"
                        placeholder="Ghi chú cho cuộc hẹn của bạn..."
                    />
                </form>
            </div>
        ...
        <div class="center-button">
            <button type="submit" form="appointmentForm" class="submit-button">
                Đặt lịch
            </button>
        </div>
